...
@endsection
@section('content')
 <section class="page-title" style="background-image:url(images/background/C_server.jpg)">
        <div class="auto-container">
            <div class="container">
                @lang('messages.cloud_server')
               ...
               <!--Image Column-->
                ...
                <center>
                    <div class="image" style="max-width: 90%;">
                        <img src="https://stratecsa.com/images/Cloud_Server-compressed.jpg" alt="" />
                    </div>
                    </center>
                </div>                
                <!--Content Column-->
                <div class="content-column col-md-6 col-sm-12 col-xs-12">
                    <div class="inner-column">
                        @lang('messages.cloud_server_mensaje')
                        </div>
    ...
    <!-- end section -->
     <!-- What Services We Offer -->
        <div id="rs-services" class="rs-services container-fluid ">
            <div class="container">
                 <div class="sec-title">
                        <h3 class="text-center"><small></small><br>@lang('messages.cloud_server_beneficios')</h3>
                     </div>
                <div class="row services-wrap">
                    <div class="col-md-5 col-sm-12 text-right service-col-left">
                        <div class="services-item">
                            <div class="services-desc">
                                @lang('messages.cloud_server_beneficios2')
                            </div>                               
                            <div class="glyph-icon flaticon-chart"></div>
                        </div>
                        <div class="services-item">
                            <div class="services-desc">
                                @lang('messages.cloud_server_beneficios3')
                            </div>
