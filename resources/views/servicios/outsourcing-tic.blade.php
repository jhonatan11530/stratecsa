...
@endsection
@section('content')
 <section class="page-title" style="background-image:url(images/background/outSourcing.jpg)">
        <div class="auto-container">
            <div class="container">
                @lang('messages.outsourcing')
               ...
               <!--Image Column-->
                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="image" style="max-width: 90%;">
                        <img src="{{ URL::asset('images/servicios/outsour.jpg') }}" alt="" />
                    </div>
                    </center>
                </div>                
                <!--Content Column-->
                <div class="content-column col-md-6 col-sm-12 col-xs-12">
                    <div class="inner-column">
                        @lang('messages.outsourcing_mensaje')
                        </div>
    ...
    <!-- end section -->
     <!-- What Services We Offer -->
        <div id="rs-services" class="rs-services container-fluid ">
            <div class="container">
                 <div class="sec-title">
                        <h3 class="text-center"><small></small><br>@lang('messages.outsourcing_beneficios')</h3>
                ...
                <div class="row services-wrap">
                    <div class="col-md-5 col-sm-12 text-right service-col-left">
                        <div class="services-item">
                            <div class="services-desc">
                                @lang('messages.outsourcing_beneficios2')
                            </div>                               
                            <div class="glyph-icon flaticon-chart"></div>
                        </div>
                        <div class="services-item">
                            <div class="services-desc">
                                @lang('messages.outsourcing_beneficios3')
                            </div>
                        ...
                        <div class="services-item">
                            <div class="services-desc">
                                @lang('messages.outsourcing_beneficios4')
                    ...
                    <div class="col-md-5 col-sm-12 right-icon service-col-right">
                        <div class="services-item">
                            ...
                            <div class="services-desc">
                                @lang('messages.outsourcing_beneficios5')
                            </div>
                        </div>
                        <div class="services-item">
                            <div class="glyph-icon flaticon-technology"></div>
                            <div class="services-desc">
                                @lang('messages.outsourcing_beneficios6')
                            </div>
                        </div>
                        <div class="services-item">
                            <div class="glyph-icon flaticon-rocket-ship"></div>
                            <div class="services-desc">
                                @lang('messages.outsourcing_beneficios7')
                            </div>
                        </div>
                    </div>   
                </div>
