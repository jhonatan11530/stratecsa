...
<body>
  <div hidden class="wrapper fadeInDown">
    <div id="formContent">
      <!-- Tabs Titles -->
      <h2 class="active"> Fechas </h2>
      {{-- <h2 class="inactive underlineHover">Sign Up </h2> --}}
  
      <!-- Icon -->
      <div class="fadeIn first">
        <img src="https://stratecsa.com/assets/images/logo15a.png" id="icon" alt="User Icon" />
      </div>
      ...
      <form action="/saveDate" method="post">
        ...
        <input type="date" id="Fecha" class="fadeIn third" name="Fecha" placeholder="Fecha">
