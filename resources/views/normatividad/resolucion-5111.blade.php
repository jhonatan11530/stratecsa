...
@section('content')
    ...
    <div class="container" style="margin-top: 3rem; margin-bottom: 3rem;">
        <div class="row">
                <div class="col-md-12">
                    <div class="head-title text-center" style="margin-bottom: 2rem;">
                        <h3 style="font-weight: 700;color: #292a2e; font-size: 30px; margin-bottom: 1rem;">Resolución<span class="text-azulCorp"> 511</span></h3>                        
        ...
        <div class="col-md-12">
            <iframe  src="{{URL::asset('assets/resolucion-5111.pdf')}}"></iframe>        
        </div>
    </div>
@endsection