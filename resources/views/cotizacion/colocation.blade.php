...
@section('content')
    <section class="page-title" style="background-image:url(../../images/background/22.jpg)">
        <div class="auto-container">
            <div class="container">
                <h2 class="tamañotitulo">Colocation Stratecsa</h2>
                <div class="text">Stratecsa Colocation cuenta con un espacio sofisticado y seguro para el alojamiento<br>de sus equipos o servidores.
              </div>
        ...
        <div class="container" style="margin-top: 3rem; margin-bottom: 3rem;">
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <form class="sky-form" action="/email/cotizar/colocation" id="formDcorpus" method="get">
                        {{ csrf_field() }}
                            <header>Cotización de colocation</header>
                            <fieldset>
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
