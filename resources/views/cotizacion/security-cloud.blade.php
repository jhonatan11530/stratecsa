...
@section('content')
    <section class="page-title" style="background-image:url(../../images/background/22.jpg)">
        <div class="auto-container">
            <div class="container">
                <h2 class="tamañotitulo">Security Cloud</h2>
                <div class="text">Brindamos servicios de seguridad en la nube<br> para protección de servidores y aplicaciones.
              </div>
        ...
        <div class="container" style="margin-top: 3rem; margin-bottom: 3rem;">
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <form class="sky-form" action="/email/security/cloud" id="formDcorpus" method="get">
                        {{ csrf_field() }}
                            <header>Cotización de security cloud</header>
                            <fieldset>
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
