...
@section('content')
    <section class="page-title" style="background-image:url(../../images/background/22.jpg)">
        <div class="auto-container">
            <div class="container">
                <h2 class="tamañotitulo">Servidor Dedicado</h2>
                <div class="text">Servidores proporcionados por STRATECSA y diseñados según<br> las mejores prácticas de la industria.
              </div>
       ...
       <div class="container" style="margin-top: 3rem; margin-bottom: 3rem;">
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <form class="sky-form" action="/email/cotizar/servidor/dedicado" id="formDcorpus" method="get">
                        {{ csrf_field() }}
                            <header>Cotización de servidor dedicado</header>
                            <fieldset>
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
