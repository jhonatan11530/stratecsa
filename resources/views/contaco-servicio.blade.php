...
@section('content')
    <section class="page-title" style="background-image:url(../../images/background/22.jpg)">
        <div class="auto-container">
            <div class="container">
                ...
                <div class="text">Enlace de datos te brinda soluciones que te <br> permiten manejar en linea tús operaciones.
              </div>
    ...
    <section>
        <div class="container" style="margin-top: 3rem;">
            <div class="row">
                <div class="col-md-8">
                    <form class="sky-form" action="/email/contacto/servicio" id="formDcorpus" method="get">
                        {{ csrf_field() }}
